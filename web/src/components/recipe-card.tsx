...
export default function RecipeCard({ recipe }: RecipeCardProps) {
  return (
    <Link
      ...
      className="group flex flex-col border border-foreground-dark/15 py-2 px-3 rounded-md w-full h-44 cursor-pointer hover:bg-background-dark/45 hover:shadow-sm duration-150"
    >
