...
export default function RecipesPage({ searchParams }: MyRecipesPageProps) {
  ...
  return (
    <PageContentWrapper className="flex flex-col w-3/5 border-l border-r border-black/5 mx-auto shadow-[inset_8px_0_8px_-8px_rgba(0,0,0,0.3),inset_-8px_0_8px_-8px_rgba(0,0,0,0.3)]">
